...
("MAG_bx"       ,   -1e5,       0,          1e5,        "f", "default",     "Magnetometer's offset of x-axis."),
("MAG_by"       ,   -1e5,       0,          1e5,        "f", "default",     "Magnetometer's offset of x-axis."),
("MAG_bz"       ,   -1e5,       0,          1e5,        "f", "default",     "Magnetometer's offset of x-axis."),
("MAG_sx"       ,   -1e5,       1,          1e5,        "f", "default",     "Magnetometer's scale of x-axis."),
("MAG_sy"       ,   -1e5,       1,          1e5,        "f", "default",     "Magnetometer's scale of x-axis."),
("MAG_sz"       ,   -1e5,       1,          1e5,        "f", "default",     "Magnetometer's scale of x-axis."),
("MAG_nox"      ,   -1e5,       0,          1e5,        "f", "default",     "Magnetometer's non-orthogonality parameter."),
("MAG_noy"      ,   -1e5,       0,          1e5,        "f", "default",     "Magnetometer's non-orthogonality parameter."),
("MAG_noz"      ,   -1e5,       0,          1e5,        "f", "default",     "Magnetometer's non-orthogonality parameter."),
...
("SINS_en_extr",    0,          0,          1,          "u", "default",     "NULL"),
...
("SINS_R_pos_sns",  0.0,        5,          10000,      "f", "default",     "NULL"),
("SINS_R_alt_sns",  0.0,        5,          10000,      "f", "default",     "NULL"),
("SINS_R_vel_sns",  0.0,        0.2,        10000,      "f", "default",     "NULL"),
("SINS_R_odo",      0.0,        0.1,        10000,      "f", "default",     "NULL"),
("SINS_R_nhl_y",    0.0,        0.1,        10000,      "f", "default",     "NULL"),
("SINS_R_nhl_z",    0.0,        0.1,        10000,      "f", "default",     "NULL"),
("SINS_R_baro",     0.0,        0.3,        100,        "f", "default",     "NULL"),
("SINS_R_mag",      0.0,        0.3,        100,        "f", "default",     "NULL"),
("SINS_R_euler",    0.0,        0.01,       100,        "f", "default",     "NULL"),
...
("SINS_B_acc_b",    0.0,        1,          10000000,   "f", "default",     "NULL"),
("SINS_B_gyr_b",    0.0,        1,          10000000,   "f", "default",     "NULL"),

("SINS_Qm_acc",     0.0,        0.1,        1000000,    "f", "default",     "NULL"),
("SINS_Qm_gyr",     0.0,        0.01,       1000000,    "f", "default",     "NULL"),
("SINS_Qm_acc_bias",0.0,        0.000001,   1000000,    "f", "default",     "NULL"),
("SINS_Qm_gyr_bias",0.0,        0.000001,   1000000,    "f", "default",     "NULL"),
