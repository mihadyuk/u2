...
{"TIME_zone", {.i32 = -24}, {.i32 = 0}, {.i32 = 24}, &gp_val[133], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  "Simple offset in hours."},
{"FLEN_adc", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[134], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_pres_dyn", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[135], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_pres_stat", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[136], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_climb", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[137], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_gnd_speed", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[138], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_reserved2", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[139], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_reserved3", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[140], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_reserved4", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[141], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"SPD_pulse2m", {.f32 = 0.000000}, {.f32 = 0.055556}, {.f32 = 1.000000}, &gp_val[142], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    "Multiply odometer pulses count by this coefficient to get\ntrip in meters. Coarse value is 0.05555555"},
{"SPD_iGain", {.f32 = -1.000000}, {.f32 = 0.000000}, {.f32 = 1.000000}, &gp_val[143], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"SPD_pGain", {.f32 = -200.000000}, {.f32 = 0.000000}, {.f32 = 200.000000}, &gp_val[144], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"SPD_dGain", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[145], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"SPD_iMin", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[146], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"SPD_iMax", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[147], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"HDG_iGain", {.f32 = -1.000000}, {.f32 = 0.000000}, {.f32 = 1.000000}, &gp_val[148], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"HDG_pGain", {.f32 = -200.000000}, {.f32 = 0.000000}, {.f32 = 200.000000}, &gp_val[149], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"HDG_dGain", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[150], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"HDG_iMin", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[151], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"HDG_iMax", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[152], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"SPD_speed", {.f32 = 0.000000}, {.f32 = 0.000000}, {.f32 = 60.000000}, &gp_val[153], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"SPD_speed_max", {.f32 = 0.000000}, {.f32 = 0.000000}, {.f32 = 60.000000}, &gp_val[154], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"XTRACK_iGain", {.f32 = -1.000000}, {.f32 = 0.000000}, {.f32 = 1.000000}, &gp_val[155], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"XTRACK_pGain", {.f32 = -200.000000}, {.f32 = 0.000000}, {.f32 = 200.000000}, &gp_val[156], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"XTRACK_dGain", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[157], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"XTRACK_iMin", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[158], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"XTRACK_iMax", {.f32 = -10000.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[159], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"DBG_lat", {.f32 = -360.000000}, {.f32 = 0.000000}, {.f32 = 360.000000}, &gp_val[160], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"DBG_lon", {.f32 = -360.000000}, {.f32 = 0.000000}, {.f32 = 360.000000}, &gp_val[161], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"DBG_reserved2", {.f32 = 0.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[162], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"param_end_mark", {.u32 = 0}, {.u32 = 0}, {.u32 = 1224}, &gp_val[163], PARAM_DEFAULT, MAVLINK_TYPE_UINT32_T, "Fake parameter with maximum allowable name length"},
};
