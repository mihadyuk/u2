...
{"T_raw_imu", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[93], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, "Interval of sending this data in milliseconds.\nSet it to 0 for disabling"},
{"T_scal_imu", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[94], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_highres_imu", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[95], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_raw_press", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[96], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_scal_press", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[97], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_attitude", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[98], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_vfr_hud", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[99], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_gps_int", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[100], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_sys_status", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[101], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_position_ned", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[102], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_nav_output", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[103], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
