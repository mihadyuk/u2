...
{"T_gps_int", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[158], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_sys_status", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[159], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_position_ned", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[160], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_nav_output", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[161], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_debug", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[162], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_debug_vect", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[163], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_rc", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[164], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"T_rc_scaled", {.u32 = 10}, {.u32 = 0}, {.u32 = 5000}, &gp_val[165], PARAM_SEND_TMO, MAVLINK_TYPE_UINT32_T, NULL},
{"TIME_zone", {.i32 = -24}, {.i32 = 0}, {.i32 = 24}, &gp_val[166], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  "Simple offset in hours."},
{"FLEN_adc", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[167], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_pres_dyn", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[168], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_pres_stat", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[169], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_climb", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[170], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_gnd_speed", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[171], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_reserved2", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[172], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_reserved3", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[173], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"FLEN_reserved4", {.i32 = 1}, {.i32 = 16}, {.i32 = 32768}, &gp_val[174], PARAM_DEFAULT, MAVLINK_TYPE_INT32_T,  NULL},
{"SPD_pulse2m", {.f32 = 0.000000}, {.f32 = 0.055556}, {.f32 = 1.000000}, &gp_val[175], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    "Multiply odometer pulses count by this coefficient to get\ntrip in meters. Coarse value is 0.05555555"},
{"SPD_speed", {.f32 = 0.000000}, {.f32 = 0.000000}, {.f32 = 60.000000}, &gp_val[176], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"SPD_speed_max", {.f32 = 0.000000}, {.f32 = 0.000000}, {.f32 = 60.000000}, &gp_val[177], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"DBG_lat", {.f32 = -360.000000}, {.f32 = 0.000000}, {.f32 = 360.000000}, &gp_val[178], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"DBG_lon", {.f32 = -360.000000}, {.f32 = 0.000000}, {.f32 = 360.000000}, &gp_val[179], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"DBG_reserved2", {.f32 = 0.000000}, {.f32 = 0.000000}, {.f32 = 10000.000000}, &gp_val[180], PARAM_DEFAULT, MAVLINK_TYPE_FLOAT,    NULL},
{"param_end_mark", {.u32 = 0}, {.u32 = 0}, {.u32 = 1224}, &gp_val[181], PARAM_DEFAULT, MAVLINK_TYPE_UINT32_T, "Fake parameter with maximum allowable name length"},
};
