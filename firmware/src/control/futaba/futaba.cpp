...
static const float BREAK_FAILSAFE     = 0.4;
static const float FLAPPERON_FAILSAFE = 0.9;
...
void Futaba::failSafe(void){
  ...
  impact.angle[SERVO_NUMBER_LEFT_FLAP]   = FLAPPERON_FAILSAFE;
  impact.angle[SERVO_NUMBER_RIGHT_FLAP]  = FLAPPERON_FAILSAFE;
