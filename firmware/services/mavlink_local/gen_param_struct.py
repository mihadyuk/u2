...
import param_table_ns, param_table_acs, param_table_uav
...
f.write("const int32_t OnboardParamCount =" + str(len(param)) + ";\n")
f.write("""
/*
 * variable array of parameters in RAM
 */
 """)
f.write("static floatint " + arr + "[" +str(len(param)) + "];\n")
f.write("""
/**
 *
 */
 """)
f.write("const GlobalParam_t GlobalParam[] = {\n")
